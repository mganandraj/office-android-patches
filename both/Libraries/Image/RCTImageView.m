diff --git a/E:/github/ms-react-native-forpatch/Libraries/Image/RCTImageView.m b/E:/github/fb-react-native-forpatch/Libraries/Image/RCTImageView.m
index 4d077e371..e2f221ba8 100644
--- a/E:/github/ms-react-native-forpatch/Libraries/Image/RCTImageView.m
+++ b/E:/github/fb-react-native-forpatch/Libraries/Image/RCTImageView.m
@@ -34,54 +34,6 @@ static BOOL RCTShouldReloadImageForSizeChange(CGSize currentSize, CGSize idealSi
...
-
  ...
  * JSON parameter.
@@ -126,32 +78,15 @@ static NSDictionary *onLoadParamsForSource(RCTImageSource *source)
...
@@ -164,7 +99,6 @@ static NSDictionary *onLoadParamsForSource(RCTImageSource *source)
...
@@ -176,13 +110,9 @@ static NSDictionary *onLoadParamsForSource(RCTImageSource *source)
...
-#endif // ]TODO(macOS ISS#2323203)
 ...
 {
@@ -192,31 +122,15 @@ RCT_NOT_IMPLEMENTED(- (instancetype)initWithFrame:(CGRect)frame)
   }
...
@@ -230,11 +144,6 @@ RCT_NOT_IMPLEMENTED(- (instancetype)initWithFrame:(CGRect)frame)
 {
...
@@ -290,21 +199,9 @@ RCT_NOT_IMPLEMENTED(- (instancetype)initWithFrame:(CGRect)frame)
     if (_resizeMode == RCTResizeModeRepeat) {
...
@@ -332,14 +229,12 @@ RCT_NOT_IMPLEMENTED(- (instancetype)initWithFrame:(CGRect)frame)
   _imageSource = nil;
 }
...
-#endif // TODO(macOS ISS#2323203)
 ...
 {
@@ -357,11 +252,7 @@ RCT_NOT_IMPLEMENTED(- (instancetype)initWithFrame:(CGRect)frame)
     return nil;
   }
...
@@ -424,11 +315,7 @@ RCT_NOT_IMPLEMENTED(- (instancetype)initWithFrame:(CGRect)frame)
     };
...
@@ -483,12 +370,7 @@ RCT_NOT_IMPLEMENTED(- (instancetype)initWithFrame:(CGRect)frame)
         return;
       }
...
-#endif // TODO(macOS ISS#2323203)
       ...
       self.image = image;
@@ -539,31 +421,13 @@ RCT_NOT_IMPLEMENTED(- (instancetype)initWithFrame:(CGRect)frame)
     [self reloadImage];
...
@@ -590,35 +454,10 @@ RCT_NOT_IMPLEMENTED(- (instancetype)initWithFrame:(CGRect)frame)
   }
 }
...
@@ -630,10 +469,4 @@ RCT_NOT_IMPLEMENTED(- (instancetype)initWithFrame:(CGRect)frame)
   }
 }
