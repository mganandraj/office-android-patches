diff --git a/E:/github/ms-react-native-forpatch/Libraries/PushNotificationIOS/RCTPushNotificationManager.m b/E:/github/fb-react-native-forpatch/Libraries/PushNotificationIOS/RCTPushNotificationManager.m
index 53b10c430..b0280744e 100644
--- a/E:/github/ms-react-native-forpatch/Libraries/PushNotificationIOS/RCTPushNotificationManager.m
+++ b/E:/github/fb-react-native-forpatch/Libraries/PushNotificationIOS/RCTPushNotificationManager.m
@@ -7,9 +7,7 @@
...
@@ -42,15 +40,12 @@ RCT_ENUM_CONVERTER(NSCalendarUnit,
...
@@ -71,50 +66,12 @@ RCT_ENUM_CONVERTER(NSCalendarUnit,
   }
   return notification;
 }
...
-#endif // TODO(macOS ISS#2323203)
 ...
 @end
 #endif //TARGET_OS_TV
@@ -124,7 +81,7 @@ RCT_ENUM_CONVERTER(UIBackgroundFetchResult, (@{
...
+#if !TARGET_OS_TV
 ...
 {
@@ -169,26 +126,6 @@ static NSDictionary *RCTFormatUNNotification(UNNotification *notification)
 }
...
@@ -245,16 +181,9 @@ RCT_EXPORT_MODULE()
...
-#if !TARGET_OS_OSX // TODO(macOS ISS#2323203)
 ...
 {
@@ -298,19 +226,6 @@ RCT_EXPORT_MODULE()
...
@@ -319,13 +234,10 @@ RCT_EXPORT_MODULE()
...
@@ -360,21 +271,12 @@ RCT_EXPORT_MODULE()
     return;
   }
...
-#if !TARGET_OS_OSX // TODO(macOS ISS#2323203)
 RCT_EXPORT_METHOD(onFinishRemoteNotification:(NSString *)notificationId fetchResult:(UIBackgroundFetchResult)result) {
   ...
   if (!completionHandler) {
@@ -392,20 +293,13 @@ RCT_EXPORT_METHOD(onFinishRemoteNotification:(NSString *)notificationId fetchRes
...
-#endif // ]TODO(macOS ISS#2323203)
 ...
 /**
@@ -413,23 +307,17 @@ RCT_EXPORT_METHOD(setApplicationIconBadgeNumber:(NSInteger)number)
  */
...
@@ -440,7 +328,6 @@ RCT_EXPORT_METHOD(requestPermissions:(NSDictionary *)permissions
...
@@ -459,23 +346,6 @@ RCT_EXPORT_METHOD(requestPermissions:(NSDictionary *)permissions
...
@@ -485,72 +355,37 @@ RCT_EXPORT_METHOD(abandonPermissions)
...
@@ -563,22 +398,15 @@ RCT_EXPORT_METHOD(cancelLocalNotifications:(NSDictionary<NSString *, id> *)userI
         *stop = YES;
       }
     }];
-#if !TARGET_OS_OSX // TODO(macOS ISS#2323203)
...
@@ -593,66 +421,36 @@ RCT_EXPORT_METHOD(getInitialNotification:(RCTPromiseResolveBlock)resolve
   } else {
     resolve((id)kCFNull);
   }
-#else // [TODO(macOS ISS#2323203)
...
@@ -664,13 +462,6 @@ RCT_EXPORT_METHOD(getDeliveredNotifications:(RCTResponseSenderBlock)callback)
