diff --git a/E:/github/ms-react-native-forpatch/Libraries/Text/TextInput/Singleline/RCTUITextField.m b/E:/github/fb-react-native-forpatch/Libraries/Text/TextInput/Singleline/RCTUITextField.m
index 4c86eebc3..3d1af3d35 100644
--- a/E:/github/ms-react-native-forpatch/Libraries/Text/TextInput/Singleline/RCTUITextField.m
+++ b/E:/github/fb-react-native-forpatch/Libraries/Text/TextInput/Singleline/RCTUITextField.m
@@ -11,105 +11,22 @@
...
@@ -140,115 +57,27 @@ static RCTUIColor *defaultPlaceholderTextColor()
 - (void)setTextContainerInset:(UIEdgeInsets)textContainerInset
 {
   _textContainerInset = textContainerInset;
-#if !TARGET_OS_OSX // TODO(macOS ISS#2323203)
...
@@ -264,21 +93,8 @@ static RCTUIColor *defaultPlaceholderTextColor()
     return;
   }
...
+                                                               attributes:[self placeholderEffectiveTextAttributes]];
 ...
 - (BOOL)isEditable
@@ -288,15 +104,9 @@ static RCTUIColor *defaultPlaceholderTextColor()
...
@@ -363,85 +173,9 @@ static RCTUIColor *defaultPlaceholderTextColor()
 {
...
-#if !TARGET_OS_OSX // TODO(macOS ISS#2323203)
 ...
 {
   if (!notifyDelegate) {
@@ -458,23 +192,6 @@ static RCTUIColor *defaultPlaceholderTextColor()
   [super paste:sender];
   _textWasPasted = YES;
 }
-#else // [TODO(macOS ISS#2323203)
...
@@ -488,19 +205,8 @@ static RCTUIColor *defaultPlaceholderTextColor()
 {
...
@@ -514,13 +220,4 @@ static RCTUIColor *defaultPlaceholderTextColor()
