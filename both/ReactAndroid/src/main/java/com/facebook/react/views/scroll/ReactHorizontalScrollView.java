diff --git a/E:/github/ms-react-native-forpatch/ReactAndroid/src/main/java/com/facebook/react/views/scroll/ReactHorizontalScrollView.java b/E:/github/fb-react-native-forpatch/ReactAndroid/src/main/java/com/facebook/react/views/scroll/ReactHorizontalScrollView.java
index 1fed7a88e..18687228c 100644
--- a/E:/github/ms-react-native-forpatch/ReactAndroid/src/main/java/com/facebook/react/views/scroll/ReactHorizontalScrollView.java
+++ b/E:/github/fb-react-native-forpatch/ReactAndroid/src/main/java/com/facebook/react/views/scroll/ReactHorizontalScrollView.java
...
@@ -75,9 +72,6 @@ public class ReactHorizontalScrollView extends HorizontalScrollView implements
...
-  private final Rect mTempRect = new Rect();
   ...
   public ReactHorizontalScrollView(Context context) {
     this(context, null);
@@ -227,82 +221,6 @@ public class ReactHorizontalScrollView extends HorizontalScrollView implements
...
@@ -345,48 +263,6 @@ public class ReactHorizontalScrollView extends HorizontalScrollView implements
     return false;
   }
...
-
   ...
   public boolean onTouchEvent(MotionEvent ev) {
     if (!mScrollEnabled) {
@@ -785,6 +661,7 @@ public class ReactHorizontalScrollView extends HorizontalScrollView implements
     } else if (velocityX < 0) {
...
@@ -829,29 +706,6 @@ public class ReactHorizontalScrollView extends HorizontalScrollView implements
     }
   }
