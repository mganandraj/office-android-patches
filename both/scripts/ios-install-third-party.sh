diff --git a/E:/github/ms-react-native-forpatch/scripts/ios-install-third-party.sh b/E:/github/fb-react-native-forpatch/scripts/ios-install-third-party.sh
index 26b49e19d..6638acbcd 100644
--- a/E:/github/ms-react-native-forpatch/scripts/ios-install-third-party.sh
+++ b/E:/github/fb-react-native-forpatch/scripts/ios-install-third-party.sh
@@ -71,19 +71,7 @@ mkdir -p third-party
