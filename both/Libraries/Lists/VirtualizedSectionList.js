diff --git a/E:/github/ms-react-native-forpatch/Libraries/Lists/VirtualizedSectionList.js b/E:/github/fb-react-native-forpatch/Libraries/Lists/VirtualizedSectionList.js
index d2e26533f..ebd12dfad 100644
--- a/E:/github/ms-react-native-forpatch/Libraries/Lists/VirtualizedSectionList.js
+++ b/E:/github/fb-react-native-forpatch/Libraries/Lists/VirtualizedSectionList.js
@@ -12,16 +12,11 @@
...
@@ -40,7 +35,6 @@ export type SectionBase<SectionItemT> = {
   renderItem?: ?(info: {
     item: SectionItemT,
     index: number,
-    isSelected?: boolean, // TODO(macOS ISS#2323203)
     ...
     separators: {
       highlight: () => void,
@@ -57,12 +51,6 @@ type RequiredProps<SectionT: SectionBase<any>> = {
 };
...
-  enableSelectionOnKeyPress?: ?boolean, // TODO(macOS ISS#2323203)
    ...
    */
@@ -77,7 +65,6 @@ type OptionalProps<SectionT: SectionBase<any>> = {
   renderItem?: (info: {
     item: Item,
     index: number,
-    isSelected?: boolean, // TODO(macOS ISS#2323203)
     ...
     separators: {
       highlight: () => void,
@@ -115,19 +102,6 @@ type OptionalProps<SectionT: SectionBase<any>> = {
...
@@ -149,10 +123,7 @@ export type Props<SectionT> = RequiredProps<SectionT> &
...
@@ -232,127 +203,12 @@ class VirtualizedSectionList<
           ? stickyHeaderIndices
           : undefined,
       },
...
@@ -449,24 +305,6 @@ class VirtualizedSectionList<
     }
   };
...
-
   _renderItem = ({item, index}: {item: Item, index: number}) => {
     ...
     if (!info) {
@@ -494,7 +332,6 @@ class VirtualizedSectionList<
           }
           cellKey={info.key}
           index={infoIndex}
...
@@ -565,7 +402,6 @@ type ItemWithSeparatorProps = $ReadOnly<{|
   cellKey: string,
   index: number,
   item: Item,
-  isSelected: boolean,
   ...
   prevCellKey?: ?string,
   renderItem: Function,
@@ -667,13 +503,11 @@ class ItemWithSeparator extends React.Component<
       SeparatorComponent,
       item,
       index,
