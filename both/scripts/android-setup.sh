diff --git a/E:/github/ms-react-native-forpatch/scripts/android-setup.sh b/E:/github/fb-react-native-forpatch/scripts/android-setup.sh
index ee8ed15d2..c76f520b9 100644
--- a/E:/github/ms-react-native-forpatch/scripts/android-setup.sh
+++ b/E:/github/fb-react-native-forpatch/scripts/android-setup.sh
@@ -16,23 +16,19 @@ function getAndroidPackages {
