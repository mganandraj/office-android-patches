diff --git a/E:/github/ms-react-native-forpatch/RNTester/RCTTest/FBSnapshotTestCase/FBSnapshotTestController.m b/E:/github/fb-react-native-forpatch/RNTester/RCTTest/FBSnapshotTestCase/FBSnapshotTestController.m
index 4b8ca2125..ac66a147c 100644
--- a/E:/github/ms-react-native-forpatch/RNTester/RCTTest/FBSnapshotTestCase/FBSnapshotTestController.m
+++ b/E:/github/fb-react-native-forpatch/RNTester/RCTTest/FBSnapshotTestCase/FBSnapshotTestController.m
@@ -10,6 +10,8 @@
...
@@ -65,7 +67,7 @@ typedef struct RGBAPixel {
...
+  UIImage *image = [UIImage imageWithContentsOfFile:filePath];
   if (nil == image && NULL != errorPtr) {
     ...
     if (!exists) {
@@ -236,19 +238,11 @@ typedef NS_ENUM(NSUInteger, FBTestSnapshotFileNameType) {
...
-  fileName = [fileName stringByAppendingString:@"_macOS"]; // TODO(macOS ISS#2323203)
   ...
   return fileName;
@@ -294,7 +288,7 @@ typedef NS_ENUM(NSUInteger, FBTestSnapshotFileNameType) {
...
+- (BOOL)_performPixelComparisonWithView:(UIView *)view
                              ...
                              identifier:(NSString *)identifier
                                   error:(NSError **)errorPtr
@@ -315,7 +309,7 @@ typedef NS_ENUM(NSUInteger, FBTestSnapshotFileNameType) {
   return NO;
 }
...
+- (BOOL)_recordSnapshotOfView:(UIView *)view
                    ...
                    identifier:(NSString *)identifier
                         error:(NSError **)errorPtr
@@ -324,20 +318,15 @@ typedef NS_ENUM(NSUInteger, FBTestSnapshotFileNameType) {
...
@@ -353,15 +342,7 @@ typedef NS_ENUM(NSUInteger, FBTestSnapshotFileNameType) {
