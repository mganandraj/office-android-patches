diff --git a/E:/github/ms-react-native-forpatch/Libraries/Lists/VirtualizedList.js b/E:/github/fb-react-native-forpatch/Libraries/Lists/VirtualizedList.js
index eb7b794ff..b896b3b5f 100644
--- a/E:/github/ms-react-native-forpatch/Libraries/Lists/VirtualizedList.js
+++ b/E:/github/fb-react-native-forpatch/Libraries/Lists/VirtualizedList.js
@@ -11,13 +11,13 @@
...
@@ -48,12 +47,6 @@ type ViewabilityHelperCallbackTuple = {
   }) => void,
 };
...
@@ -177,19 +164,6 @@ type OptionalProps = {
...
@@ -264,11 +238,7 @@ type ChildListState = {
...
@@ -407,25 +377,6 @@ class VirtualizedList extends React.PureComponent<Props, State> {
     );
   }
...
@@ -647,7 +598,6 @@ class VirtualizedList extends React.PureComponent<Props, State> {
...
@@ -744,7 +694,6 @@ class VirtualizedList extends React.PureComponent<Props, State> {
           index={ii}
...
@@ -1099,12 +1048,6 @@ class VirtualizedList extends React.PureComponent<Props, State> {
   }
...
@@ -1120,7 +1063,6 @@ class VirtualizedList extends React.PureComponent<Props, State> {
...
-          onScrollKeyDown={keyEventHandler} // TODO(macOS ISS#2323203)
           refreshControl={
             props.refreshControl == null ? (
               <RefreshControl
@@ -1136,7 +1078,7 @@ class VirtualizedList extends React.PureComponent<Props, State> {
       );
     } else {
       // $FlowFixMe Invalid prop usage
...
@@ -1258,80 +1200,6 @@ class VirtualizedList extends React.PureComponent<Props, State> {
...
@@ -1790,7 +1658,6 @@ class CellRenderer extends React.Component<
     horizontal: ?boolean,
     index: number,
...
@@ -1867,7 +1734,6 @@ class CellRenderer extends React.Component<
       item,
       index,
       inversionStyle,
...
@@ -1875,7 +1741,6 @@ class CellRenderer extends React.Component<
